  ...
  return (
    <AutocompletePrimitive.Item
      ...
      className={cn(
        ...
        "rounded-2xl",
        "data-highlighted:before:rounded-2xl",
      ...
      >
        <div className="relative flex max-h-full">
          <AutocompletePrimitive.Popup
            ...
            className={cn(
              "bg-popover text-popover-foreground rounded-3xl shadow-md ring-foreground/10 flex max-h-[min(var(--available-height),24rem)] w-(--anchor-width) max-w-(--available-width) origin-(--transform-origin) scroll-pt-2 scroll-pb-2 flex-col overscroll-contain py-0.5 ring-1 transition-[scale,opacity] has-data-starting-style:scale-98 has-data-starting-style:opacity-0 has-data-[side=none]:scale-100 has-data-[side=none]:transition-none",
              className
            )}
            {...props}
          >
...
function AutocompleteTrigger({
  ...
  return (
    <AutocompletePrimitive.Trigger
      ...
      {...props}
    >
      <IconSelector className="size-4 opacity-70" />
    </AutocompletePrimitive.Trigger>
  )
}
